export const terms = [
  {
    ...
    enabled: true,
    content:
      '본 서비스의 이용조건과 회원의 권리·의무를 규정합니다. 주요 내용: ①계정 생성·관리, 비밀번호 보호 의무 ②타인의 권리를 침해하는 게시·행위 금지(불법·허위·스팸·악성코드 등) ③서비스 변경·중단 및 공지 ④이용제한(약관/법령 위반, 부정 이용 시) ⑤손해배상과 책임 제한(불가항력·제3자 장애 등) ⑥분쟁 해결 절차 및 준거법. 약관에 동의하지 않으면 서비스 이용(게스트 신청 포함)이 제한될 수 있습니다.',
  },
  {
    id: 'privacy',
    title: '개인정보 수집·이용 동의',
