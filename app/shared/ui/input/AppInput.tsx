// components/inputs/AppInput.tsx
...
export type AppInputProps = Omit<RNTextInputProps, 'value' | 'style'> & {
  edit?: boolean
...
export default function AppInput({
  ...
  const {
    ...
    activeUnderlineColor: _activeUnderlineColor,
    // outlineStyle 필터링 (부모로부터 rest로 올 수 있음)
    outlineStyle: _paperOutlineStyle,
    ...inputProps
  } = rest as typeof rest & PaperInputCompatProps
